...
class CanonicalShapeTest(unittest.TestCase):
    ...
    def test_no_remaining_v1_record_gains_v2_fields(self):
        for rid in self.current_manual_1:
            doc = self.raw_by_id[rid]
    ...
    def test_every_v1_and_v2_id_is_accounted_for(self):
        self.assertEqual(set(self.raw_by_id), self.frozen_247 | self.unordered_47 | self.historical_manual_2)
        self.assertEqual(set(), (self.frozen_247 | self.unordered_47) & self.historical_manual_2)
