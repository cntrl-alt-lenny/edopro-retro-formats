...
`DUEL_MODE_GOAT = DUEL_MODE_MR1 | <12 extra flags>`. GOAT **removes nothing** from MR1 (pure superset; `GOAT & ~MR1 = 0x7F800002C`). Extra flags added, with at least one engine usage site and plain-language effect each:
